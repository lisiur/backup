...
/***/ "../../../rongzer/flow-editor/build/flow-editor.js":
/*!***********************************************************************!*\
  !*** /Users/lisiur/Projects/rongzer/flow-editor/build/flow-editor.js ***!
  \***********************************************************************/
...
class Editor {
    ...
    init() {
        const origin = new _node__WEBPACK_IMPORTED_MODULE_0__["default"]({
        ...
        const target = new _node__WEBPACK_IMPORTED_MODULE_0__["default"]({
            interface: new _interface__WEBPACK_IMPORTED_MODULE_1__["default"]({
                input: ["id"],
                output: "id",
            }),
...
class Node {
    ...
    constructor(params) {
        ...
        const isSource = params.interface.input.length > 0
        const isTarget = !!params.interface.output
        const common = {
            connector: "Flowchart",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var flow_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! flow-editor */ "../../../rongzer/flow-editor/build/flow-editor.js");
/* harmony import */ var flow_editor__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(flow_editor__WEBPACK_IMPORTED_MODULE_0__);


new flow_editor__WEBPACK_IMPORTED_MODULE_0___default.a({
